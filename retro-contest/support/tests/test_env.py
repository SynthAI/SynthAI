...
class BitEnv(lab.Env):
    def __init__(self):
        self.action_space = lab.spaces.Discrete(8)
        self.observation_space = lab.spaces.Discrete(2)
...
class MultiBitEnv(lab.Env):
    def __init__(self):
        self.action_space = lab.spaces.MultiBinary(3)
        self.observation_space = lab.spaces.Discrete(2)
...
class StepEnv(lab.Env):
    def __init__(self):
        self.action_space = lab.spaces.Discrete(2)
        self.observation_space = lab.spaces.Discrete(1)
        self.reward = 0
        self.done = False
