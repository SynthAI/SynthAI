...
"""
Synthnetes setup.py for PIP install
"""

from setuptools import setup, find_packages
from synthnetes.version import PROJECT_NAME, VERSION, DESCRIPTION, URL, AUTHOR, AUTHOR_EMAIL, LICENCE
...
setup(
    ...
    keywords='jsunset kubernetes reclass jinja',
    py_modules=["synthnetes"],
    ...
    entry_points={
        'console_scripts': [
            'synthnetes=synthnetes.cli:main',
        ],
    },
)
