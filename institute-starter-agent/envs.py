import cv2
from lab.spaces.box import Box
import numpy as np
import lab
...
from institute.wrappers import BlockingReset, LabCoreAction, EpisodeID, Unvectorize, Vectorize, Vision, Logger
from institute import spaces as vnc_spaces
from institute.spaces.vnc_event import keycode
import time
...
def create_env(env_id, client_id, remotes, **kwargs):
    ...
    if spec.tags.get('flashgames', False):
        ...
        # Assume atari.
        assert "." not in env_id  # institute environments have dots in names.
