...
class RunnerThread(threading.Thread):
    """
One of the key distinctions between a normal environment and a institute environment
is that a institute environment is _real time_.  This means that there should be a thread
