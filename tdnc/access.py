...
class MemoryAccess(snt.RNNCore):
  ...
  *   `addressing.FreenessAllocator` for keeping track of memory usage, where
  ...
  def __init__(self,
    ...
    Args:
      memory_size: The number of memory slots (N in the TDNC paper).
      word_size: The width of each memory slot (W in the TDNC paper)
      num_reads: The number of read heads (R in the TDNC paper).
