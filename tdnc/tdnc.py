...
These modules create a TDNC core. They take input, pass parameters to the memory
...
TDNCState = collections.namedtuple('TDNCState', ('access_output', 'access_state',
                                               'controller_state'))


class TDNC(snt.RNNCore):
  """TDNC core module.
  ...
  def __init__(self,
    ...
    Args:
      ...
      name: module name (default 'tdnc').

    Raises:
      TypeError: if direct_input_size is not None for any access module other
        than KeyValueMemory.
    """
    super(TDNC, self).__init__(name=name)
  ...
  def _build(self, inputs, prev_state):
    """Connects the TDNC core into the graph.

    Args:
      inputs: Tensor input.
      prev_state: A `TDNCState` tuple containing the fields `access_output`,
    ...
    Returns:
      ...
      is a `TDNCState` tuple containing the fields `access_output`,
