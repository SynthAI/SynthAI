...
# ==============================================================================
"""Example script to train the TDNC on a repeated copy task."""
...
tf.flags.DEFINE_integer("clip_value", 20,
                        "Maximum absolute value of controller and tdnc outputs.")
...
tf.flags.DEFINE_string("checkpoint_dir", "/tmp/tf/tdnc",
...
def run_model(input_sequence, output_size):
  ...
  tdnc_core = tdnc.TDNC(access_config, controller_config, output_size, clip_value)
  initial_state = tdnc_core.initial_state(FLAGS.batch_size)
...
def train(num_training_iterations, report_interval):
  """Trains the TDNC and periodically reports the loss."""
