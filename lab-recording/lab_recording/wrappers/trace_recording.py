...
from lab_recording.recording import TraceRecording
...
class TraceRecordingWrapper(lab.Wrapper):
    """
    ...
    with a manifest in /tmp/mytraces/synthailab.traces.*.
    See lab_recording.recording for more on the file format

    Later you can load the recorded traces:

      import lab_recording.playback

      def episode_cb(observations, actions, rewards):
          ... do something the episode ...

      lab_recording.playback.scan_recorded_traces('/tmp/mytraces', episode_cb)
