...
from .lizard import Lizard, FOML
...
def argument_parser():
    ...
    parser.add_argument('--foml', help='use FOML instead of Lizard', action='store_true')
...
def train_kwargs(parsed_args):
    ...
    return {
        ...
        'lizard_fn': _args_lizard(parsed_args)
    }
