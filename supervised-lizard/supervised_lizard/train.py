...
def train(sess,
    ...
    for i in range(meta_iters):
        ...
        lizard.train_step(train_set, model.input_ph, model.label_ph, model.minimize_op,
        ...
        if i % eval_interval == 0:
            ...
            for dataset, writer in [(train_set, train_writer), (test_set, test_writer)]:
                correct = lizard.evaluate(dataset, model.input_ph, model.label_ph,
