"""
Supervised Lizard learning and evaluation on arbitrary
datasets.
"""
...
class Lizard:
    ...
    Lizard can operate in two evaluation modes: normal
    ...
    def train_step(self,
                   ...
                   meta_batch_size):
        """
        Perform a Lizard training step.
...
class FOML(Lizard):
    ...
    FOML is similar to Lizard, except that you use the
    gradient from the last mini-batch as the update
    direction.

    There are two ways to sample batches for FOML.
    By default, FOML samples batches just like Lizard,
