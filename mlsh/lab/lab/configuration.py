...
# Should be "lab", but we'll support people doing somewhat crazy
# things.
package_name = '.'.join(__name__.split('.')[:-1])
lab_logger = logging.getLogger(package_name)

# Should be modified only by official Lab plugins. This is an
# unsupported API and may be removed in future versions.
_extra_loggers = [lab_logger]
...
# We need to take in the lab logger explicitly since this is called
...
def undo_logger_setup():
    """Undoes the automatic logging setup done by SynthAI Lab. You should call
