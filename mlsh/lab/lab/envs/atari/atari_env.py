...
try:
    ...
    raise error.DependencyNotInstalled("{}. (HINT: you can install Atari dependencies by running 'pip install lab[atari]'.)".format(e))
...
class AtariEnv(lab.Env, utils.EzPickle):
    ...
    def __init__(self, game='pong', obs_type='ram', frameskip=(2, 5), repeat_action_probability=0.):
        ...
        # https://github.com/synthai/lab/issues/349
