...
from lab import error, version
import os, json, logging, numpy as np, six
from lab.monitoring import stats_recorder, video_recorder
...
class Monitor(Wrapper):
    ...
    def _start(self, directory, video_callable=None, force=False, resume=False,
        ...
        if self.env.spec is None:
            logger.warning("Trying to monitor an environment which has no 'spec' set. This usually means you did not create it via 'lab.make', and is recommended only for advanced users.")
            env_id = '(unknown)'
        else:
