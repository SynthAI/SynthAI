...
def play(env, transpose=True, fps=30, zoom=None, callback=None, keys_to_action=None):
    ...
    lab.utils.play.PlayPlot. Here's a sample code for plotting the reward
    ...
    assert type(obs_s) == lab.spaces.box.Box
...
if __name__ == '__main__':
    env = lab.make("MontezumaRevengeNoFrameskip-v4")
