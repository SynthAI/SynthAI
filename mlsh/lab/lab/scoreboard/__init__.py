...
from lab.scoreboard.client.resource import Algorithm, BenchmarkRun, Evaluation, FileUpload
from lab.scoreboard.registration import registry, add_task, add_group, add_benchmark

# Discover API key from the environment. (You should never have to
# change api_base / web_base.)
env_key_names = ['SYNTHAI_LAB_API_KEY', 'SYNTHAI_LAB_API_BASE', 'SYNTHAI_LAB_WEB_BASE']
api_key = os.environ.get('SYNTHAI_LAB_API_KEY')
api_base = os.environ.get('SYNTHAI_LAB_API_BASE', 'https://lab-api.synthai.com')
web_base = os.environ.get('SYNTHAI_LAB_WEB_BASE', 'https://lab.synthai.com')
...
add_task(
    ...
    description="""\
Like the classic cartpole task `[1] <https://lab.synthai.com/envs/CartPole-v0>`_
...
add_task(
    ...
    description="""\
Like the classic cartpole task `[1] <https://lab.synthai.com/envs/CartPole-v0>`_ but the environment now contains an observed binary shut-down signal.
...
.. _cartpole task: https://lab.synthai.com/envs/CartPole-v0
""",
...
In the classic version of the pendulum problem `[1] <https://lab.synthai.com/envs/Pendulum-v0>`_,
