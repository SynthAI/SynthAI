...
import lab.scoreboard.client
from lab.scoreboard.client import http_client
...
class APIRequestor(object):
    def __init__(self, key=None, api_base=None):
        self.api_base = api_base or lab.scoreboard.api_base
        self.api_key = key
    ...
    def request_raw(self, method, url, params=None, supplied_headers=None):
        ...
        if self.api_key:
            ...
            my_api_key = lab.scoreboard.api_key

        if my_api_key is None:
            raise error.AuthenticationError("""You must provide an SynthAI Lab API key.

(HINT: Set your API key using "lab.scoreboard.api_key = .." or "export SYNTHAI_LAB_API_KEY=..."). You can find your API key in the SynthAI Lab web interface: https://lab.synthai.com/settings/profile.""")
        ...
        if method == 'get' or method == 'delete':
            ...
            raise error.APIConnectionError(
                ...
                'SynthAI Lab bindings.  Please contact lab@synthai.com for '
                'assistance.' % (method,))
        ...
        headers = {
            'Synthai-Lab-User-Agent': json.dumps(ua),
            'User-Agent': 'Synthai-Lab/v1 PythonBindings/%s' % (version.VERSION,),
