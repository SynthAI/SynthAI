...
class Env(object):
    """The main SynthAI Lab class. It encapsulates an environment with
    ...
    @property
    def monitor(self):
        raise error.Error("env.monitor has been deprecated as of 12/23/2016. Remove your call to `env.monitor.start(directory)` and instead wrap your env with `env = lab.wrappers.Monitor(env, directory)` to record data.")
    ...
    def unwrapped(self):
        ...
        Returns:
            lab.Env: The base non-wrapped lab.Env instance
        """
        return self
    ...
    def configure(self, *args, **kwargs):
        raise error.Error("Env.configure has been removed in lab v0.8.0, released on 2017/03/05. If you need Env.configure, please use lab version 0.7.x from pip, or checkout the `lab:v0.7.4` tag from git.")
