...
An "agent" describes the method of running an RL algorithm against an environment in the lab. The agent may contain the algorithm itself or simply provide an integration between an algorithm and the lab environments. Submit another to this list via a pull-request. 
...
Agent implementing tabular Q-learning located in this repo at `lab/examples/agents/tabular_q_agent.py`. 
