...
class SimpleMonitor(lab.Wrapper):
...
def get_wrapper_by_name(env, classname):
    """Given an a lab environment possibly wrapped multiple times, returns a wrapper
    of class named classname or raises ValueError if no such wrapper was applied

    Parameters
    ----------
    env: lab.Env of lab.Wrapper
        lab environment
    classname: str
        name of the wrapper
    ...
    while True:
        if classname == currentenv.class_name():
            return currentenv
        elif isinstance(currentenv, lab.Wrapper):
