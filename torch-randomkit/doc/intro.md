...
Provides and wraps the Randomkit library, copied from Numpy. Please check-out its [website](http://synthai.github.io/torch-randomkit) for up-to-date documentation or read below.
