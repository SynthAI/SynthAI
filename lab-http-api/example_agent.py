...
from lab_http_client import Client
...
if __name__ == '__main__':
    ...
    # Upload to the scoreboard. This expects the 'SYNTHAI_LAB_API_KEY'
    # environment variable to be set on the client side.
    logger.info("""Successfully ran example agent using
        lab_http_client. Now trying to upload results to the
        scoreboard. If this fails, you likely need to set
        os.environ['SYNTHAI_LAB_API_KEY']=<your_api_key>""")
