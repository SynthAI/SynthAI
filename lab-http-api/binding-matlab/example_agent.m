%% Example using matlab lab_http_client interface
% Example:
% 1) Server: python lab_http_server.py
% 2) Client: matlab -nojvm -nodisplay -nosplash -r "run example_agent.m"
fprintf('Testing Matlab client\n');

%% Setup client
base = 'http://127.0.0.1:5000';
client = lab_http_client(base);
...
% This expects the 'SYNTHAI_LAB_API_KEY' enviroment variable to be set on
% the client side.
