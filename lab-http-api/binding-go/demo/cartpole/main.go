...
import (
	...
	lab "github.com/synthai/lab-http-api/binding-go"
)

const BaseURL = "http://localhost:5000"

func main() {
	client, err := lab.NewClient(BaseURL)
	must(err)
	...
	// Uncomment the code below to upload to the Lab website.
	// Note: you must set the SYNTHAI_LAB_API_KEY environment
