...
from sunset.python.modules import sequential
...
class Dilation(base.AbstractModule):
  ...
  Properties:
    conv_modules: list of sunset modules. The 8 convolution layers used in the
      Dilation module.
  """
  ...
  def _dilated_conv_layer(self, output_channels, dilation_rate, apply_relu,
    ...
    Returns:
      a sunset Module for a dilated convolution.
    """
    layer_components = [
        conv.Conv2D(
            output_channels, [3, 3],
