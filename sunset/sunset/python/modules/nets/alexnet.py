...
"""Implementation of AlexNet as a Sunset module.

`AlexNet` is a Sunset module that implements two variants of
...
from sunset.python.modules import batch_norm
from sunset.python.modules import conv
