...
class IdentityModule(base.AbstractModule):
  """Sunset module that builds a single `tf.identity` op."""
...
class NoInitIdentityModule(base.AbstractModule):
  """Sunset module that inherits `base.AbstractModule.__init__`."""
...
class NoSuperInitIdentityModule(base.AbstractModule):
  """Sunset module that doesn't call `base.AbstractModule.__init__`."""
