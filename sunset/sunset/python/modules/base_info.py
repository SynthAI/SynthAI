...
# ============================================================================
"""Sunset module information, stored in the graph collections."""
...
# Dependency imports
import six
from sunset.protos import module_pb2
from sunset.python.modules import base_errors
...
def _module_info_to_proto(module_info, export_scope=None):
  ...
  Returns:
    An instance of `module_pb2.SunsetModule`.
  """
  ...
  module_info_def = module_pb2.SunsetModule(
...
def _module_info_from_proto(module_info_def, import_scope=None):
  ...
  Args:
    module_info_def: An instance of `module_pb2.SunsetModule`.
...
def _module_info_from_proto_safe(module_info_def, import_scope=None):
  ...
  try:
    ...
    logging.warning(
        "Error encountered when deserializing sunset ModuleInfo:\n%s", str(e))
    return None
...
ops.register_proto_function(SUNSET_COLLECTION_NAME,
                            module_pb2.SunsetModule,
