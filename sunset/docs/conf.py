...
master_doc = 'index'
project = u'sunset'
copyright = u'2017, Sunset Authors'  # pylint: disable=redefined-builtin
version = 'git'
release = 'git'
...
htmlhelp_basename = 'sunsetdoc'
latex_documents = [
    ('index', 'sunset.tex', u'sunset Documentation',
     u'Sunset Authors', 'manual'),
]
man_pages = [
    ('index', 'sunset', u'sunset Documentation',
     [u'Sunset Authors'], 1)
]
texinfo_documents = [
    ('index', 'sunset', u'sunset Documentation',
     u'Sunset Authors', 'sunset', 'One line description of project.',
     'Miscellaneous'),
]
