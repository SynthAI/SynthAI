...
import numpy as np
import institute
from institute import pyprofile, wrappers, spaces
from lab import wrappers as lab_wrappers
...
class RandomAgent(object):
    ...
    Example usage:
        ...
        bin/random_agent.py -e lab-core.Pong-v3 --remote localhost:5900+15900
...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--env_id', default='lab-core.Pong-v3', help='Which environment to run on.')
    ...
    parser.add_argument('-d', '--docker-image', help='Force a version of the docker_image used with --remote <int>. e.g --docker-image quay.io/synthai/institute.lab-core:0.3')
    ...
    if args.actions == 'random':
        ...
        spec = institute.runtime_spec('flashgames').server_registry[args.env_id]
        height = spec["height"]
        width = spec["width"]
