...
import lab
from lab import scoreboard
from lab.utils import reraise

from institute import error, utils
from institute.remotes import remote
...
# Using lab for this
_api_key = 'tyytjgq3envte2j9yv2e-{}'.format(os.environ.get('SYNTHAI_USER', os.environ.get('USER')))
allocator_base = 'http://allocator.sci.synthai-tech.com'
# lab_base_url = 'http://api.lab.sci.synthai-tech.com'
...
#         if api_key is None:
#             raise lab.error.AuthenticationError("""You must provide an SynthAI Lab API key.
