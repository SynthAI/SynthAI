...
import institute.scoreboard
import institute.configuration
from institute import error, envs
from institute.remotes import docker_remote
from institute.rewarder import merge_infos
from institute.runtimes.registration import runtime_spec
...
def docker_image(runtime_id):
    logger.warn('DEPRECATION WARNING: institute.docker_image(runtime_id) is deprecated and will be removed soon. Use runtime_spec(runtime_id).image instead. ')
...
def enable_logfile(path=None):
    raise error.Error('Renamed to "institute.configure_logging()"')
...
def configure_logging(path=None):
    ...
    Set up log levels, and split verbose logs to a file
        ...
        verbose log file located at /tmp/institute-<pid>.log
    ...
    if path is False:
        ...
        path = '/tmp/institute-{}.log'.format(os.getpid())
...
#
#    Institute environments are registered with the lab
#    environment registry when the institute module
#    is imported. We use the "tags" field to store
#    additional data specific to Institute.


#------------------------ Lab core environments -----------------------#
#     Asynchronous VNC versions of core lab environments,
...
register(
    id='lab-core.CartPoleLowDSync-v0',
    entry_point='institute.wrappers:WrappedLabCoreSyncEnv',
...
register(
    id='lab-core.CartPoleLowD-v0',
    entry_point='institute.wrappers:WrappedLabCoreEnv',
    max_episode_steps=500,
    tags={
        'vnc': True,
        'runtime': 'lab-core',
...
for game in ['air_raid', 'alien', 'amidar', 'assault', 'asterix',
    ...
    for version in [0, 3]:
        lab_core_id = '{}-v{}'.format(base, version) # e.g. SpaceInvaders-v3
        register(
            id='lab-core.{}'.format(lab_core_id),
            entry_point='institute.wrappers:WrappedLabCoreEnv',
            ...
            kwargs={
                'lab_core_id': lab_core_id,
            },
        )

        register(
            id='lab-core.{}Sync-v{}'.format(base, version),
            entry_point='institute.wrappers:WrappedLabCoreSyncEnv',
            max_episode_steps=100000,
            tags={
                'vnc': True,
        ...
        register(
            id='lab-core.{}30FPS-v{}'.format(base, version),
            entry_point='institute.wrappers:WrappedLabCoreEnv',
            max_episode_steps=100000,
            tags={
                'vnc': True,
        ...
        register(
            id='lab-core.{}Slow-v{}'.format(base, version),
            entry_point='institute.wrappers:WrappedLabCoreEnv',
            max_episode_steps=100000,
            tags={
                'vnc': True,
        ...
        deterministic_lab_core_id = '{}Deterministic-v{}'.format(base, version) # e.g. SpaceInvadersDeterministic-v3

        register(
            id='lab-core.{}Deterministic-v{}'.format(base, version),
            entry_point='institute.wrappers:WrappedLabCoreEnv',
            max_episode_steps=100000,
            tags={
                'vnc': True,
            ...
            kwargs={
                'lab_core_id': deterministic_lab_core_id,
            },
        )
        register(
            id='lab-core.{}DeterministicSlow-v{}'.format(base, version),
            entry_point='institute.wrappers:WrappedLabCoreEnv',
        ...
        register(
            id='lab-core.{}DeterministicSync-v{}'.format(base, version),
            entry_point='institute.wrappers:WrappedLabCoreSyncEnv',
            max_episode_steps=75000,
            tags={
                'vnc': True,
        ...
        no_frameskip_lab_core_id = '{}NoFrameskip-v{}'.format(base, version) # e.g. SpaceInvadersNoFrameskip-v3
        register(
            id='lab-core.{}NoFrameskip-v{}'.format(base, version),
            entry_point='institute.wrappers:WrappedLabCoreEnv',
            ...
            kwargs={
                'lab_core_id': no_frameskip_lab_core_id,
            },
        )
...
# Please keep this registry mirrored with the benchmarks in institute-envs/flashgames/lab_flashgames/__init__.py
# You can use institute-envs/flashgames/bin/manage export_env_ids_for_registration to generate this list.
for game in [
    ...
    register(
        id=game,
        entry_point='institute.wrappers:WrappedFlashgamesEnv',
...
register(
    ...
    entry_point='institute.vnc:WrappedFlashgamesEnv',
...
for _task in ['Learn', 'Test']:
    for _name in ['Geography', 'Planet', 'Institute', 'Comet', 'Moon', 'Mars', 'Solar-System']:
...
for game in vnc_world_of_bits:
    register(
        id=game,
        entry_point='institute.wrappers:WrappedVNCEnv',
        max_episode_steps=10**7,
        tags={
            'vnc': True,
            'wob': True,
...
#     Institute environment. Here we include
...
for id in ['starcraft.TerranAstralBalance-v0']:
    register(
        id=id,
        entry_point='institute.wrappers:WrappedStarCraftEnv',
        max_episode_steps=10**7,
        tags={
            'vnc': True,
            'starcraft': True,
...
for gtav_game in ['gtav.SaneDriving-v0', 'gtav.Speed-v0']:
    register(
        id=gtav_game,
        entry_point='institute.wrappers:WrappedGTAVEnv',
        max_episode_steps=10**7,
        tags={
            'vnc': True,
            'gtav': True,
...
register(
    ...
    entry_point='institute.wrappers:WrappedWorldOfGooEnv',
    max_episode_steps=10**7,
    tags={
        'vnc': True,
        'wog': True,
...
for slith_game in ['SlitherIO-v0', 'SlitherIONoSkins-v0', 'SlitherIOEasy-v0']:
    register(
        ...
        entry_point='institute.wrappers:WrappedInternetEnv',
        max_episode_steps=10**7,
        tags={
            'vnc': True,
            'internet': True,
