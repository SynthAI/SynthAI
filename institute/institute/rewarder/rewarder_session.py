...
from institute import utils
from institute.twisty import reactor
from institute.rewarder import connection_timer, env_status, reward_buffer, rewarder_client
from institute.utils import display
...
class RewarderSession(object):
    ...
    def _connect(self, name, address, env_id, seed, fps, i, network, env_status, reward_buffer,
        ...
        factory.headers = {'authorization': utils.basic_auth_encode(password), 'synthai-observer': 'true' if observer else 'false'}
        factory.i = i
