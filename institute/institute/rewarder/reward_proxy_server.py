...
class RewardProxyServer(websocket.WebSocketServerProtocol, object):
    ...
    def begin_recording(self):
        ...
        Version 0 can be seen here: https://github.com/synthai/institute/blob/f85a7779c3847fa86ec7bb513a1da0d3158dda78/bin/recording_agent.py
        """
    ...
    def connect_upstream(self, tries=1, max_attempts=7):
        ...
        if self._request.headers.get('synthai-observer'):
            headers['synthai-observer'] = self._request.headers.get('synthai-observer')
