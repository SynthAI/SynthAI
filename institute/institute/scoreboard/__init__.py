from lab.benchmarks import scoring
from lab.benchmarks import register_benchmark

register_benchmark(
    id='Atari7VNC-v0',
    scorer=scoring.TotalReward(),
    name='AtariVNC',
    description='7 Atari games, with pixel observations (using institute)',
    tasks=[
        {
