...
class _InstituteMonitor(core.Wrapper):
    ...
    def _start_monitor(self):
        ...
        if hasattr(lab, 'wrappers'):
            self._monitor = lab.wrappers.Monitor(self._unvectorized_envs[0],
            ...
            logger.warn("DEPRECATION WARNING: You are using an older version of lab that has a deprecated Monitor, please update to lab:v0.8.0. This change was made 2017/02/01 and is included in institute version 0.21.3")
            from lab import monitoring
    ...
    def _close(self):
        super(_InstituteMonitor, self)._close()
        self._monitor.close()
...
def Monitor(env, directory, video_callable=None, force=False, resume=False,
    ...
    return _InstituteMonitor(TimeLimit(env), directory, video_callable, force, resume,
