import lab
import logging
from institute import rewarder, spaces, vectorized

logger = logging.getLogger(__name__)

class LabCoreSync(vectorized.Wrapper):
    ...
    def __init__(self, env):
        super(LabCoreSync, self).__init__(env)
        self.reward_n = None
        self.done_n = None
        self.info = None
    ...
    def _step(self, action_n):
        ...
        while True:
            ...
            if count > 0:
                logger.debug('[LabCoreSync] Still waiting on %d envs to receive their post-commit reward', count)
            else:
                break
    ...
    def _flip_past(self, observation_n, reward_n, done_n, info):
        ...
        while True:
            ...
            if count == 0:
                ...
                logger.debug('[LabCoreSync] Still waiting on %d envs to catch up to their targets: %s', count, deltas)
