# import numpy as np
# from institute import vectorized
...
# from institute.envs import vnc_env
import lab
import numpy as np
import os
import institute
...
from institute.rewarder import rewarder_client, rewarder_session, reward_buffer
from institute import spaces, wrappers
...
def test_connect():
    ...
    assert vnc_session._to_dict() == {'0': {'name': '0', 'subsample_level': 2, 'encoding': 'tight', 'fine_quality_level': 50, 'start_timeout': 7, 'address': 'example.com:5900', 'password': 'synthai'}}
    assert rewarder_session._to_dict() == {'0': {'start_timeout': 7, 'seed': None, 'name': '0', 'fps': 60, 'address': 'example.com:15900', 'env_id': 'flashgames.DuskDrive-v0', 'password': 'synthai', 'skip_network_calibration': False, 'observer': False, 'label': '0:example.com:5900'}}
