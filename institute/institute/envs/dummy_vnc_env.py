...
from institute import error, rewarder, spaces, utils, vectorized
from institute.envs import diagnostics
from institute.remotes import healthcheck
...
class DummyVNCEnv(vectorized.Env):
    ...
    >>> dummy_env = lab.make('test.DummyVNCEnv-v0')
    >>> e = YourActionWrapper(dummy_env)
    >>> e = institute.wrappers.Unvectorize(e)
