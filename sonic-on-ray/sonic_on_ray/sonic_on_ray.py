...
class SonicDiscretizer(lab.ActionWrapper):
    """
    Wrap a lab-retro environment and make it use discrete
    ...
    def __init__(self, env):
        ...
        self.action_space = lab.spaces.Discrete(len(self._actions))

    def action(self, a):
        return self._actions[a].copy()


class RewardScaler(lab.RewardWrapper):
    """
