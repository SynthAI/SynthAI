...
def configure(dir=None, format_strs=None):
    if dir is None:
        dir = os.getenv('SYNTHAI_LOGDIR')
    if dir is None:
        dir = osp.join(tempfile.gettempdir(),
            datetime.datetime.now().strftime("synthai-%Y-%m-%d-%H-%M-%S-%f"))
    ...
    if format_strs is None:
        strs, strs_mpi = os.getenv('SYNTHAI_LOG_FORMAT'), os.getenv('SYNTHAI_LOG_FORMAT_MPI')
