'''
from synthbase/ppo1/mlp_policy.py and add simple modification
...
from synthbase.common.mpi_running_mean_std import RunningMeanStd
from synthbase.common.distributions import make_pdtype
from synthbase.acktr.utils import dense
...
class MlpPolicy(object):
    ...
    def _init(self, ob_space, ac_space, hid_size, num_hid_layers, gaussian_fixed_var=True):
        assert isinstance(ob_space, lab.spaces.Box)
        ...
        if gaussian_fixed_var and isinstance(ac_space, lab.spaces.Box):
