...
register_benchmark({
    'name': 'Synthtraining 8M',
    'description': 'Small 2D tasks, up to 30 minutes to complete on 8 cores',
    'tasks': [
        {'env_id': "Synthtraining Reacher-v1", 'trials': 4, 'num_timesteps': 2 * 1000000},
        {'env_id': "Synthtraining Ant-v1", 'trials': 4, 'num_timesteps': 8 * 1000000},
        {'env_id': "Synthtraining HalfCheetah-v1", 'trials': 4, 'num_timesteps': 8 * 1000000},
        {'env_id': "Synthtraining Hopper-v1", 'trials': 4, 'num_timesteps': 8 * 1000000},
        {'env_id': "Synthtraining Walker2d-v1", 'trials': 4, 'num_timesteps': 8 * 1000000},
    ]
})
register_benchmark({
    'name': 'Synthtraining Harder',
    'description': 'Test your might!!! Up to 12 hours on 32 cores',
    'tasks': [
        {'env_id': "Synthtraining Humanoid-v1", 'trials': 4, 'num_timesteps': 100 * 1000000},
        {'env_id': "Synthtraining HumanoidFlagrun-v1", 'trials': 4, 'num_timesteps': 200 * 1000000},
        {'env_id': "Synthtraining HumanoidFlagrunHarder-v1", 'trials': 4, 'num_timesteps': 400 * 1000000},
    ]
})
