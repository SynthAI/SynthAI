...
def get_dims(env):
    if isinstance(env.action_space, lab.spaces.Discrete):
        if isinstance(env.observation_space, lab.spaces.Discrete):
            env_dim = env.observation_space.n
        elif isinstance(env.observation_space, lab.spaces.MultiDiscrete):
