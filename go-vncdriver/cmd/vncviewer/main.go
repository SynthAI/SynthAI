...
func toImage(s *labvnc.Screen) image.Image {
...
func main() {
	...
	s := labvnc.NewVNCSession("", labvnc.VNCSessionConfig{
		Address:  os.Args[1],
		Password: "synthai",
		Encoding: "tight",
	})
