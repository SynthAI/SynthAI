"""
Demonstrates SynthSumo with pre-trained policies.
"""
import click
import lab
import os
...
import synthsumo.envs

from synthsumo.policy_zoo import LSTMPolicy, MLPPolicy
from synthsumo.policy_zoo.utils import load_params, set_from_flat
...
@click.option("--env", type=str,
              default="SynthSumo-Ant-vs-Ant-v0", show_default=True,
...
def main(env, policy_names, param_versions, max_episodes):
    ...
    params_dir = os.path.join(curr_dir, "../synthsumo/policy_zoo/assets")
