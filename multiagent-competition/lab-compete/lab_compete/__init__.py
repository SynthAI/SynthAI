...
register(
    ...
    entry_point='lab_compete.new_envs:MultiAgentEnv',
...
register(
    ...
    entry_point='lab_compete.new_envs:HumansBlockingEnv',
...
register(
    id='sumo-humans-v0',
    entry_point='lab_compete.new_envs:SumoEnv',
...
# register(
#     id='HumanAntArena-v0',
#     entry_point='lab_compete.new_envs:HumansKnockoutEnv',
...
register(
    ...
    entry_point='lab_compete.new_envs:KickAndDefend',
