...
class MultiDiscrete(lab.Space):
    def __init__(self, nvec):
        ...
        lab.Space.__init__(self, (self.nvec.size,), np.int8)
    def sample(self):
        return (lab.spaces.np_random.rand(self.nvec.size) * self.nvec).astype(self.dtype)
    def contains(self, x):
