...
from lab import utils, error
from lab.envs.robotics import rotations, hand_env
from lab.envs.robotics.utils import robot_get_obs

try:
    import mujoco_py
except ImportError as e:
    raise error.DependencyNotInstalled("{}. (HINT: you need to install mujoco_py, and also perform the setup instructions here: https://github.com/synthai/mujoco-py/.)".format(e))
