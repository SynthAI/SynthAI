...
class GoalEnv(Env):
    """A goal-based environment. It functions just as any regular SynthAI Lab environment but it
    ...
    def reset(self):
        ...
        if not isinstance(self.observation_space, lab.spaces.Dict):
            raise error.Error('GoalEnv requires an observation space of type lab.spaces.Dict')
