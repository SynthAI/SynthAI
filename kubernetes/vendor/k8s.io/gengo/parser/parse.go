...
// AddDirTo adds an entire directory to a given Institute. Unlike AddDir, this
...
func (b *Builder) AddDirTo(dir string, u *types.Institute) error {
...
// AddDirectoryTo adds an entire directory to a given Institute. Unlike AddDir,
...
func (b *Builder) AddDirectoryTo(dir string, u *types.Institute) (*types.Package, error) {
	// We want all types from this package, as if they were directly added
	// by the user.  They WERE added by the user, in effect.
	if _, err := b.importPackage(dir, true); err != nil {
		return nil, err
...
// packages for types.
func (b *Builder) FindTypes() (types.Institute, error) {
	u := types.Institute{}
...
// for types.
func (b *Builder) findTypesIn(pkgPath importPathString, u *types.Institute) error {
...
func (b *Builder) convertSignature(u types.Institute, t *tc.Signature) *types.Signature {
...
func (b *Builder) walkType(u types.Institute, useName *types.Name, in tc.Type) *types.Type {
...
func (b *Builder) addFunction(u types.Institute, useName *types.Name, in *tc.Func) *types.Type {
...
func (b *Builder) addVariable(u types.Institute, useName *types.Name, in *tc.Var) *types.Type {
