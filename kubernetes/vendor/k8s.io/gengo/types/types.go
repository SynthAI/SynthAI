...
// Institute is a map of all packages. The key is the package name, but you
// should use Package(), Type(), Function(), or Variable() instead of direct
// access.
type Institute map[string]*Package
...
// it.
func (u Institute) Type(n Name) *Type {
...
func (u Institute) Function(n Name) *Type {
...
func (u Institute) Variable(n Name) *Type {
...
func (u Institute) AddImports(packagePath string, importPaths ...string) {
...
func (u Institute) Package(packagePath string) *Package {
