...
func applyGroupOverrides(institute types.Institute, customArgs *clientgenargs.Args) {
...
func Packages(context *generator.Context, arguments *args.GeneratorArgs) generator.Packages {
	...
	applyGroupOverrides(context.Institute, &customArgs)
	...
	for gv, inputDir := range customArgs.GroupVersionToInputPath {
		...
		p := context.Institute.Package(path.Vendorless(inputDir))
