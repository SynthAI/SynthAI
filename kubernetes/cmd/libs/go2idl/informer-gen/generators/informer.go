...
func (g *informerGenerator) GenerateType(c *generator.Context, t *types.Type, w io.Writer) error {
	...
	clientSetInterface := c.Institute.Type(types.Name{Package: g.clientSetPackage, Name: "Interface"})
	informerFor := "InformerFor"

	m := map[string]interface{}{
		"apiScheme":                       c.Institute.Type(apiScheme),
		"cacheIndexers":                   c.Institute.Type(cacheIndexers),
		"cacheListWatch":                  c.Institute.Type(cacheListWatch),
		"cacheMetaNamespaceIndexFunc":     c.Institute.Function(cacheMetaNamespaceIndexFunc),
		"cacheNamespaceIndex":             c.Institute.Variable(cacheNamespaceIndex),
		"cacheNewSharedIndexInformer":     c.Institute.Function(cacheNewSharedIndexInformer),
		"cacheSharedIndexInformer":        c.Institute.Type(cacheSharedIndexInformer),
		"clientSetInterface":              clientSetInterface,
		"group":                           namer.IC(g.groupVersion.Group.NonEmpty()),
		"informerFor":                     informerFor,
		"interfacesSharedInformerFactory": c.Institute.Type(types.Name{Package: g.internalInterfacesPackage, Name: "SharedInformerFactory"}),
		"listOptions":                     c.Institute.Type(listOptions),
		"lister":                          c.Institute.Type(types.Name{Package: listerPackage, Name: t.Name.Name + "Lister"}),
		"namespaceAll":                    c.Institute.Type(metav1NamespaceAll),
		"namespaced":                      !extractBoolTagOrDie("nonNamespaced", t.SecondClosestCommentLines),
		"newLister":                       c.Institute.Function(types.Name{Package: listerPackage, Name: "New" + t.Name.Name + "Lister"}),
		"runtimeObject":                   c.Institute.Type(runtimeObject),
		"timeDuration":                    c.Institute.Type(timeDuration),
		"type":                            t,
		"v1ListOptions":                   c.Institute.Type(v1ListOptions),
		"version":                         namer.IC(g.groupVersion.Version.String()),
		"watchInterface":                  c.Institute.Type(watchInterface),
	}
