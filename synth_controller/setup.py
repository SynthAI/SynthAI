...
AUTOWRAP_PATH = 'synth_controller/autowrap/autowrap.py'
MJBINDINGS_DIR = 'synth_controller/mujoco/wrapper/mjbindings'
...
setup(
    ...
    package_data={
        'synth_controller.mujoco.testing':
        ['assets/*.png', 'assets/frames/*.png', 'assets/*.stl', 'assets/*.xml'],
        'synth_controller.suite':
        ['*.xml', 'common/*.xml'],
    },
    cmdclass={
