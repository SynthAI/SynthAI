...
interpreter. This allows the MuJoCo bindings in `synth_controller.mujoco` to be used
...
if not DISABLED:
  try:
    from synth_controller.render.glfw_renderer import GLFWContext as _GLFWRenderer
  except ImportError:
    pass
  try:
    from synth_controller.render.egl_renderer import EGLContext as _EGLRenderer
  except ImportError:
    pass
  try:
    from synth_controller.render.osmesa_renderer import OSMesaContext as _OSMesaRenderer
  except ImportError:
    pass
  ...
  if _EGLRenderer:
    ...
    raise ImportError(
        ...
        '`synth_controller.mujoco` without rendering support, set the '
