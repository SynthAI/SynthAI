import lab, synthtraining , sys, os
import numpy as np
...
def demo_run():
    env = lab.make("Synthtraining HumanoidFlagrun-v1")
    ...
    from Synthtraining HumanoidFlagrunHarder_v1_2017jul import ZooPolicyTensorflow
