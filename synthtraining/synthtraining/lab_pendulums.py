from synthtraining .scene_abstract import SingleRobotEmptyScene
from synthtraining .lab_mujoco_xml_env import Synthtraining MujocoXmlEnv
import lab, lab.spaces, lab.utils, lab.utils.seeding
import numpy as np
import os, sys

class Synthtraining InvertedDoublePendulum(Synthtraining MujocoXmlEnv):
    def __init__(self):
        Synthtraining MujocoXmlEnv.__init__(self, 'inverted_double_pendulum.xml', 'cart', action_dim=1, obs_dim=9)
...
class Synthtraining InvertedPendulum(Synthtraining MujocoXmlEnv):
    swingup = False

    def __init__(self):
        Synthtraining MujocoXmlEnv.__init__(self, 'inverted_pendulum.xml', 'cart', action_dim=1, obs_dim=5)
...
class Synthtraining InvertedPendulumSwingup(Synthtraining InvertedPendulum):
    swingup = True
