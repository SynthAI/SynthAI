...
if len(sys.argv) in [1,2]:
    ...
    for f in os.listdir(zoo_path):
        if not f.startswith("Synthtraining Pong"): continue
    ...
    gameserver = synthtraining .multiplayer.SharedMemoryServer(game, game_server_guid, want_test_window=False)
