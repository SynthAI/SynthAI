...
if __name__=='__main__':
    ...
    image.save("synthtraining /models_outdoor/stadium/test.png")

    #color = random_stadium_kernel.stadium_color
    #test_triangulation("synthtraining /models_outdoor/stadium/stadium1.obj", stadium_extents)
    #color = random_stadium_kernel.pong_color
    #test_triangulation("synthtraining /models_outdoor/stadium/pong1.obj", pong_extents)
    color = random_stadium_kernel.tennis_color
    test_triangulation("synthtraining /models_outdoor/stadium/tennis1.obj", tennis_extents)
