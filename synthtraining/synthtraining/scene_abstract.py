...
# but when you have synthtraining  directory in cwd or in parent(s) of cwd, python2 will use that and fail to reach site-packages.
...
#from synthtraining  import cpp_household_d as cpp_household    # you can debug C++ code
from synthtraining   import cpp_household   as cpp_household
...
class Scene:
    ...
    def __init__(self, gravity, timestep, frame_skip):
        self.np_random, seed = lab.utils.seeding.np_random(None)
