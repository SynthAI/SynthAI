import synthtraining , lab, lab.spaces, lab.utils, lab.utils.seeding
import numpy as np
import sys
...
#
# python test_manual.py Synthtraining Hopper-v0
#
...
if __name__=="__main__":
    env_id = "Synthtraining Humanoid-v0" if len(sys.argv) <= 1 else sys.argv[1]
    test(env_id)
