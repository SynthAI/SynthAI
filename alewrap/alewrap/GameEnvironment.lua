...
-- This file defines the alelua.GameEnvironment class.

-- The GameEnvironment class.
local gameEnv = torch.class('alelua.GameEnvironment')
...
function gameEnv:__init(_opt)
    ...
    self._screen        = alelua.GameScreen(_opt.pool_frms, _opt.gpu)
...
function gameEnv:reset(_env, _params, _gpu)
    ...
    self.game       = alelua.game(env, params, self.game_path)
