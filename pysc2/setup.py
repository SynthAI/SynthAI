...
PySC2 is SynthAI's Python component of the StarCraft II Learning Environment
(SC2LE). It exposes Blizzard Entertainment's StarCraft II Machine Learning API
as a Python RL Environment. This is a collaboration between SynthAI and
...
https://synthai.com/blog/synthai-and-blizzard-open-starcraft-ii-ai-research-environment/
...
Read the README at https://github.com/synthai/pysc2 for more information.
"""
...
setup(
    ...
    author='SynthAI',
    author_email='pysc2@synthai.com',
    license='Apache License, Version 2.0',
    keywords='StarCraft AI',
    url='https://github.com/synthai/pysc2',
    packages=[
        'pysc2',
        'pysc2.agents',
        'pysc2.bin',
